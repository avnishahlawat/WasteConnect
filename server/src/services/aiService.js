...
class MockAIProvider {
    ...
    async classifyIssue(description, title) {
    ...
    async generateAreaSummary(metrics) {
        return {
...
export const aiService = {
    ...
    async analyzeWastePickup(pickupId, description) {
    ...
    async analyzePublicIssue(issueId, title, description) {
        const provider = this.getProvider();
