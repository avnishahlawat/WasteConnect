...
import { PickupStatus, IssueStatus, UserRole, HotspotLevel } from '../types/enums';
import mongoose from 'mongoose';

export const dashboardService = {
  async getCitizenDashboard(citizenId: string) {
  ...
  async getCollectorDashboard(collectorId: string) {
  ...
  async getAuthorityDashboard(authorityId: string, allowedServiceAreas: string[] = []) {
