...
import { z } from 'zod';
import { TimeSlot } from '../types/enums.js';
...
export const citizenController = {
    ...
    // Pickups
    requestPickup: asyncHandler(async (req, res) => {
    ...
    getPickups: asyncHandler(async (req, res) => {
    ...
    getPickupById: asyncHandler(async (req, res) => {
        const result = await pickupService.getPickupById(req.params.id, req.user._id.toString(), req.user.role);
        sendSuccess(res, result);
    }),
    cancelPickup: asyncHandler(async (req, res) => {
    ...
    getMyIssues: asyncHandler(async (req, res) => {
        const { status, page, limit } = req.query;
    ...
    verifyIssueResolution: asyncHandler(async (req, res) => {
    ...
    classifyWasteAi: asyncHandler(async (req, res) => {
