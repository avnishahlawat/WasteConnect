...
import { IssueStatus, Severity, Priority, VerificationStatus, CitizenVerification } from '../types/enums.js';
const publicIssueSchema = new Schema({
...
export const PublicIssue = mongoose.model('PublicIssue', publicIssueSchema);
