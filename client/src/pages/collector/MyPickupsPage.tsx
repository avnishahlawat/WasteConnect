...
export default function CollectorMyPickupsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="My Route & Active Assignments"
        subtitle="Progress your scheduled collections through pickup, transport, and facility weigh-in."
        breadcrumbs={[
      ...
      {loading ? (
        ...
        <div className="bg-surface border border-border rounded-xl p-8">
          <EmptyState
            ...
            description="You do not have any collections scheduled on your route right now."
          />
        </div>
      ) : (
              ...
              >
                <div className="space-y-1.5 flex-1">
                  ...
                  <div className="text-xs text-text-muted">
                    Citizen: <strong className="text-text">{(p.citizen as any)?.firstName} {(p.citizen as any)?.lastName}</strong>
                    {(p.citizen as any)?.phone && (
                      <span className="inline-flex items-center gap-1 ml-2 text-primary font-medium">
                        <Phone className="w-3 h-3" /> {(p.citizen as any).phone}
                      </span>
                    )}
                  </div>
                ...
                <div className="flex items-center gap-2 self-end md:self-center">
                  {isAccepted && (
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-4 py-2 bg-primary text-white text-xs font-semibold rounded-md hover:bg-primary-dark transition-colors shadow-sm"
                    >
            ...
            <form onSubmit={handleCompleteSubmit} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="e.g. Segregation verified, delivered to Central Ward MRF facility..."
              ...
              <div className="flex items-center justify-end gap-2 pt-2">
                ...
                <button
                  ...
                  className="px-5 py-2 bg-status-success text-white text-xs font-semibold rounded hover:bg-green-700 disabled:opacity-50"
                >
