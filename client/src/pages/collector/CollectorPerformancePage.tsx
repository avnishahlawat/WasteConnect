...
export default function CollectorPerformancePage() {
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <PageHeader
        title="Collector Performance & Ratings"
        subtitle="Review your service reliability, volume gathered, and citizen ratings."
        breadcrumbs={[
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <MetricCard
          ...
          subtitle={`Based on ${profile.totalRatings} citizen reviews`}
          icon={Star}
          variant="default"
        />
        <MetricCard
          ...
          subtitle="Household pickups completed"
          icon={Truck}
          variant="info"
        />
        <MetricCard
          title="Volume Gathered"
          value={`${Math.round(profile.totalWeightCollected)} kg`}
          subtitle="Recyclables diverted"
          icon={Scale}
          variant="success"
        />
        <MetricCard
          title="Service Tier"
          value="Gold Partner"
          subtitle="Top 10% reliable collector"
          icon={Award}
          variant="warning"
        />
      </div>
