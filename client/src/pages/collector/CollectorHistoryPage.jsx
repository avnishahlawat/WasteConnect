...
export default function CollectorHistoryPage() {
    ...
    return (<div className="space-y-6">
      <PageHeader title="Collection History" subtitle="Historical log of all completed household waste pickups fulfilled by you." breadcrumbs={[
      ...
      {loading ? (<div className="space-y-3">
          ...
          <EmptyState icon={Clock} title="No Past Collections" description="Completed collections and delivery weight receipts will be archived here."/>
          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-border text-xs">
              {pickups.map((p) => (<tr key={p._id} className="hover:bg-gray-50/50">
                  ...
                  <td className="px-6 py-4 text-text-muted">{p.serviceArea?.name || 'Central'}</td>
