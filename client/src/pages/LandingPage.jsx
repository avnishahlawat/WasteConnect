...
import { ArrowRight, Shield, Leaf, Truck, AlertTriangle, Map, BarChart2, CheckCircle2, User, Building2, List } from 'lucide-react';
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-surface p-6 rounded-xl border border-border shadow-sm">
              <div className="text-3xl font-bold text-primary mb-2">
                {stats.resolvedIssues > 0 ? stats.resolvedIssues : (stats.completedPickups || 38)}
              </div>
              <div className="text-sm text-text-muted font-medium">Issues & Pickups Resolved</div>
            </div>
            <div className="bg-surface p-6 rounded-xl border border-border shadow-sm">
              <div className="text-3xl font-bold text-primary mb-2">
                {stats.resolutionRate || 92}%
              </div>
              <div className="text-sm text-text-muted font-medium">Resolution Rate</div>
            </div>
            <div className="bg-surface p-6 rounded-xl border border-border shadow-sm">
              <div className="text-3xl font-bold text-primary mb-2">
                {stats.serviceAreasCount || 5}
              </div>
              <div className="text-sm text-text-muted font-medium">Municipal Service Areas</div>
            </div>
            <div className="bg-surface p-6 rounded-xl border border-border shadow-sm">
              <div className="text-3xl font-bold text-primary mb-2">
                {stats.activeCollectors || 4}
              </div>
