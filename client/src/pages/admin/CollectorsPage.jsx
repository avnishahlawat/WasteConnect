...
export default function AdminCollectorsPage() {
    ...
    return (<div className="space-y-6 max-w-6xl mx-auto">
      <PageHeader title="Collector Fleet Performance" subtitle="Operational metrics, rating scores, and collection tonnages for independent and municipal drivers." breadcrumbs={[
      ...
      {loading ? (<LoadingSkeleton type="card"/>) : (<div className="bg-surface border border-border rounded-xl shadow-sm overflow-hidden">
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-border text-xs">
              {collectors.map((c) => (<tr key={c.id} className="hover:bg-gray-50/50">
