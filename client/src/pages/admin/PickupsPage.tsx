...
export default function AdminPickupsPage() {
  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
      <PageHeader
        title="Platform Household Pickups"
        subtitle="Global audit list of all private waste collection bookings and fulfillment receipts."
        breadcrumbs={[
            ...
            <tbody className="divide-y divide-border text-xs">
              {pickups.map((p) => (
                <tr key={p._id} className="hover:bg-gray-50/50">
                  ...
                  <td className="px-5 py-4 text-text-muted">{(p.serviceArea as any)?.name || 'Central'}</td>
