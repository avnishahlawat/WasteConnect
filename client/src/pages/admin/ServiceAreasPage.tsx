  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <PageHeader
          title="Service Areas & Ward Jurisdiction"
          subtitle="Configure municipal districts, operational boundaries, and geographical hotspot scoring centers."
          breadcrumbs={[
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 bg-primary text-white text-xs font-semibold px-4 py-2 rounded-md hover:bg-primary-dark shadow-sm"
        >
      ...
      {loading ? (
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {areas.map((a) => (
            <div key={a._id} className="bg-surface border border-border rounded-xl p-5 shadow-sm space-y-3">
            ...
            <form onSubmit={handleCreate} className="space-y-3 text-xs">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. West Ward (Commercial)"
