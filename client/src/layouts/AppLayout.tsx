...
import {
  LayoutDashboard, Truck, Plus, AlertTriangle, FileText, Bell, User,
  Inbox, Clock, BarChart2, List, Activity, Map, Flame, Megaphone,
  Users, Package, Tag, MapPin, Shield, Settings, Menu, X, LogOut, Leaf
} from 'lucide-react';
    ...
    <div className="flex flex-col h-full bg-surface border-r border-border">
      ...
      <div className="p-4 border-t border-border">
        ...
        <button
          ...
          className="flex items-center gap-3 w-full px-3 py-2 text-sm font-medium text-status-error hover:bg-status-errorBg rounded-md transition-colors"
        >
